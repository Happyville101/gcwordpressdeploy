...
function cyberchimps_portfolio_lite_content() {
	...
	// Getting options of portfolio-lite when added to blog
		...
		$img1 = get_theme_mod('cyberchimps_blog_portfolio_lite_image_one', get_template_directory_uri().apply_filters('cyberchimps_portfolio_lite_img_one' , '/cyberchimps/lib/images/portfolio.jpg'));
		$img2 = get_theme_mod('cyberchimps_blog_portfolio_lite_image_two', get_template_directory_uri().apply_filters('cyberchimps_portfolio_lite_img_two' , '/cyberchimps/lib/images/portfolio.jpg'));
		$img3 = get_theme_mod('cyberchimps_blog_portfolio_lite_image_three', get_template_directory_uri().apply_filters('cyberchimps_portfolio_lite_img_three' , '/cyberchimps/lib/images/portfolio.jpg'));
		$img4 = get_theme_mod('cyberchimps_blog_portfolio_lite_image_four', get_template_directory_uri().apply_filters('cyberchimps_portfolio_lite_img_four' , '/cyberchimps/lib/images/portfolio.jpg'));
		
		// Getting caption for each protfolio
		$caption1 = get_theme_mod( 'cyberchimps_blog_portfolio_lite_image_one_caption' , apply_filters('cyberchimps_portfolio_lite_image_one_caption' , ''));
		$caption2 = get_theme_mod( 'cyberchimps_blog_portfolio_lite_image_two_caption' , apply_filters('cyberchimps_portfolio_lite_image_two_caption' , ''));
		$caption3 = get_theme_mod( 'cyberchimps_blog_portfolio_lite_image_three_caption' , apply_filters('cyberchimps_portfolio_lite_image_three_caption' , ''));
		$caption4 = get_theme_mod( 'cyberchimps_blog_portfolio_lite_image_four_caption' ,  apply_filters('cyberchimps_portfolio_lite_image_four_caption' , ''));
		...
		// Getting URL of custom link
		$url1 = get_theme_mod( 'cyberchimps_blog_portfolio_link_url_one' , apply_filters('cyberchimps_portfolio_lite_url1' , ''));
		$url2 = get_theme_mod( 'cyberchimps_blog_portfolio_link_url_two' , apply_filters('cyberchimps_portfolio_lite_url2' , '') );
		$url3 = get_theme_mod( 'cyberchimps_blog_portfolio_link_url_three' , apply_filters('cyberchimps_portfolio_lite_url3' , ''));
		$url4 = get_theme_mod( 'cyberchimps_blog_portfolio_link_url_four' , apply_filters('cyberchimps_portfolio_lite_url4' , ''));
	}
